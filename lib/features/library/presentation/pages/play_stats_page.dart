  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: bg,
        elevation: 0,
        title: Text('播放统计', style: TextStyle(color: pri, fontWeight: FontWeight.bold)),
        leading: IconButton(
          ...
          return ListView(
            ...
            children: [
              ...
              if (data.topSongs.isNotEmpty) ...[
                Text('最常播放', style: TextStyle(color: pri, fontSize: 18, fontWeight: FontWeight.bold)),
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Text(
                            '${idx + 1}',
                            style: TextStyle(
                              color: idx < 3 ? YYColors.accentPrimary : tri,
                        ...
                        Column(
                          ...
                          children: [
                            Text('${item.stats.playCount} 次',
                                style: TextStyle(color: YYColors.accentPrimary, fontSize: 14, fontWeight: FontWeight.w600)),
                            Text(_formatDuration(item.stats.totalDuration),
                                style: TextStyle(color: tri, fontSize: 11)),
                          ],
                        ),
                      ],
                    ),
