...
import '../../data/services/music_scraper_manager_service.dart';
...
class MusicScraperSourcesState {
  ...
  final List<ScraperSourceEntity> sources;
...
class MusicScraperSourcesNotifier extends StateNotifier<MusicScraperSourcesState> {
  ...
  Future<void> reorder(int oldIndex, int newIndex) async {
    ...
    final sources = List<ScraperSourceEntity>.from(state.sources);
